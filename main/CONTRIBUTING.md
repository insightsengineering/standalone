...
Do not make changes to the standalone script files directly: rather,
update these files in their source location.
...
The {standalone} package exports shims for common tidyverse functions,
so you can use the function without depending on the package.

## Code of Conduct

Please note that the standalone package is released with a [Contributor
Code of
Conduct](https://insightsengineering.github.io/standalone/CODE_OF_CONDUCT.md).
